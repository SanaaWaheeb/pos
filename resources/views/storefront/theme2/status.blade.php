...
<div class="modal" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" style="background-color: rgba(0, 0, 0, 0.5)">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmModalLabel">{{__('Confirm Order')}}</h5>
                ...
                <div class="modal-body text-center">
                    <p style="margin-bottom: 15px">
                       {{ __('The confirmation should be done only from store owner')}}
                    </p>
                </div>
