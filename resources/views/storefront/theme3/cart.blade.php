                                            ...
                                            <tr data-id="{{$key}}" id="product-variant-id-{{ $product['variant_id'] }}">
                                                ...
                                                <td data-label="quantity">
                                                    <div class="qty-spinner" data-id="{{$key}}">
                                                        ...
                                                        <input type="number" class="quantity product_qty_input bx-cart-qty" data-cke-saved-name="quantity" data-id="{{$product['product_id']}}" value="{{$product['quantity']}}" id="product_qty"
                                                            name="quantity">
