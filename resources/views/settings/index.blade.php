                                                    ...
                                                    <h2 class="accordion-header" id="headingThirtySeven">
                                                        <button class="accordion-button collapsed" type="button"
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <span class="me-2">{{__('On/Off :')}}</span>
                                                                <div class="form-check form-switch d-inline-block custom-switch-v1">
                                                                    <input type="hidden" name="is_edfapay_enabled"
                                                                        value="off">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        name="is_edfapay_enabled"
                                                                        id="is_edfapay_enabled"
                                                                        {{ isset($store_payment_setting['is_edfapay_enabled']) && $store_payment_setting['is_edfapay_enabled'] == 'on' ? 'checked="checked"' : '' }}>
                                                                    <label class="custom-control-label form-label"
                                                                        for="is_edfapay_enabled"></label>
                                                                </div>
                                                            </div>
                                                        </button>
                                                    </h2>
                                                    <div id="collapseThirtySeven" class="accordion-collapse collapse"aria-labelledby="headingTThirtySeven"data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="edfapay_merchant_key"
                                                    ...
                                                    <div id="collapseThirtyEight" class="accordion-collapse collapse"aria-labelledby="headingThirtyEight"data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="ipay88_merchant_key"
                                                                            ...
                                                                            value="{{ isset($store_payment_setting['ipay88_merchant_key']) ? $store_payment_setting['ipay88_merchant_key'] : '' }}"
                                                                            placeholder="{{ __('Merchant Key') }}">
                                                                    </div>
                                                                    @if ($errors->has('ipay88_merchant_key'))
                                                                        <span class="invalid-feedback d-block">
                                                                            {{ $errors->first('ipay88_merchant_key') }}
                                                                        </span>
                                                                    @endif
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="ipay88_merchant_code"
                                                                            class="col-form-label">{{ __('Ipay88 Merchant Code') }}</label>
                                                                        <input type="text" name="ipay88_merchant_code"
                                                                            id="ipay88_merchant_code" class="form-control"
                                                                            value="{{ isset($store_payment_setting['ipay88_merchant_code']) ? $store_payment_setting['ipay88_merchant_code'] : '' }}"
                                                                            placeholder="{{ __('Ipay88 Merchant Code') }}">
                                                                    </div>
                                                                    @if ($errors->has('ipay88_merchant_code'))
                                                                        <span class="invalid-feedback d-block">
                                                                            {{ $errors->first('ipay88_merchant_code') }}
                                                                        </span>
                                                                    @endif
                                                                </div>
                                                    ...
                                                    <h2 class="accordion-header" id="headingThirtyNine">
                                                        <button class="accordion-button collapsed" type="button"
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <span class="me-2">{{__('On/Off :')}}</span>
                                                                <div class="form-check form-switch d-inline-block custom-switch-v1">
                                                                    <input type="hidden" name="is_zabeb_enabled"
                                                                        value="off">
                                                                    <input type="checkbox" class="form-check-input"
                                                                        name="is_zabeb_enabled"
                                                                        id="is_zabeb_enabled"
                                                                        {{ isset($store_payment_setting['is_zabeb_enabled']) && $store_payment_setting['is_zabeb_enabled'] == 'on' ? 'checked="checked"' : '' }}>
                                                                    <label class="custom-control-label form-label"
                                                                        for="is_zabeb_enabled"></label>
                                                                </div>
                                                            </div>
                                                        </button>
                                                    </h2>
                                                    <div id="collapseThirtyNine" class="accordion-collapse collapse"aria-labelledby="headingThirtyNine"data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="zabeb_client_id"
                                                                            class="col-form-label">{{ __('Zabeb Client ID') }}</label>
                                                                        <input type="text" name="zabeb_client_id"
                                                                            id="zabeb_client_id" class="form-control"
                                                                            value="{{ isset($store_payment_setting['zabeb_client_id']) ? $store_payment_setting['zabeb_client_id'] : '' }}"
                                                                            placeholder="{{ __('Zabeb Client ID') }}">
                                                                    </div>
                                                                    @if ($errors->has('zabeb_client_id'))
                                                                        <span class="invalid-feedback d-block">
                                                                            {{ $errors->first('zabeb_client_id') }}
                                                                        </span>
                                                                    @endif
                                                                </div>
                                                                {{-- Zabeb Secret Key --}}
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="zabeb_secret_key"
                                                                            class="col-form-label">{{ __('Zabeb Secret Key') }}</label>
                                                                        <input type="text" name="zabeb_secret_key"
                                                                            id="zabeb_secret_key" class="form-control"
                                                                            value="{{ isset($store_payment_setting['zabeb_secret_key']) ? $store_payment_setting['zabeb_secret_key'] : '' }}"
                                                                            placeholder="{{ __('Zabeb Secret Key') }}">
                                                                    </div>
                                                                    @if ($errors->has('zabeb_secret_key'))
                                                                        <span class="invalid-feedback d-block">
                                                                            {{ $errors->first('zabeb_secret_key') }}
                                                                        </span>
                                                                    @endif
                                                                </div>
