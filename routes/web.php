...
Route::group(['middleware' => ['verified']], function () {
    ...
    // Route::get('storeanalytic', [StoreAnaowner.payment.settinglytic::class, 'index'])->middleware('auth')->name('storeanalytic')->middleware(['XSS']);
...
///////////////////////////////
Route::get('clear-cart/{slug}', [StoreController::class, 'clearCart'])->name('store.cart.clear');
///////////////////////////////
...
Route::get('edfapay-payment/callback', [PaymentController::class, 'edfaPayPaymentCallback'])->name('edfapay.callback');
